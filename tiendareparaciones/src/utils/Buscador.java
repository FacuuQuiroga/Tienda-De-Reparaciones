...
public class Buscador {
	...
	public static void buscarClientes() {
		...
		do {
			...
			System.out.println("Seleccione qué tipo de Clientes quiere filtar: \n");
		...
		if (nombreSi) {
			...
			do {
				...
				nombreValido = utils.Validador.validarNombre(nombre);
				if (!nombreValido)
		...
		if (nifSi) {
			...
			do {
				...
				nifValido = utils.Validador.validarNif(nif);
				if (!nifValido)
		...
		if (telefonoSi) {
			...
			do {
				...
				telefonoValido = utils.Validador.validarTel(telefono);
				if (!telefonoValido)
		...
		if (idSi) {
			...
			do {
				System.out.println("Introduzca el nif que desea buscar: ");
				id = teclado.nextLong();
				idValido = utils.Validador.validarId(id);
				if (!idValido)
